...
class AsiaAllianseBank extends StatefulWidget {
  AsiaAllianseBank({
    Key key,
  }) : super(key: key);

  @override
  _AsiaAllianseBankState createState() => _AsiaAllianseBankState();
}

class _AsiaAllianseBankState extends State<AsiaAllianseBank> {
  @override
  void initState() {
    super.initState();
    getData();
  ...
  void getData() async {
    if (!loading) {
      try {
        ...
        String jsonString =
            await rootBundle.loadString('assets/AsiaAllianseBank.json');
