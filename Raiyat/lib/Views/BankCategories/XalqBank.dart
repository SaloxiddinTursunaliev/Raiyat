...
class XalqBank extends StatefulWidget {
  XalqBank({
    Key key,
  }) : super(key: key);

  @override
  _XalqBankState createState() => _XalqBankState();
}

class _XalqBankState extends State<XalqBank> {
  @override
  void initState() {
    super.initState();
    getData();
  ...
  void getData() async {
    if (!loading) {
      try {
        ...
        String jsonString =
            await rootBundle.loadString('assets/XalqBanki.json');
