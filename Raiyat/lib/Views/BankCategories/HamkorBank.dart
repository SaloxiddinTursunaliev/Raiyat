...
class HamkorBank extends StatefulWidget {
  HamkorBank({
    Key key,
  }) : super(key: key);

  @override
  _HamkorBankState createState() => _HamkorBankState();
}

class _HamkorBankState extends State<HamkorBank> {
  @override
  void initState() {
    super.initState();
    getData();
  ...
  void getData() async {
    if (!loading) {
      try {
        ...
        String jsonString =
            await rootBundle.loadString('assets/HamkorBank.json');
